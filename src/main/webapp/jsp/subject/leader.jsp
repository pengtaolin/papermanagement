	                        ...
	                        <div class="col-xs-12">
	                            <div class="card">
	                                <div class="card-body">
	                                        	...
	                                        	<c:forEach items="${subjectList.list }" var="subject" varStatus="i">
	                                        		<tr>
		                                                ...
		                                                <td><fmt:formatDate value="${subject.createtime }" pattern="yyyy-MM-dd"/></td>
		                                           		<td><a href="/subject/leader/state/${subject.subjectid }/4.html">通过</a></td>
		                                           		<td><a href="/subject/leader/state/${subject.subjectid }/3.html">不通过</a></td>
		                                            </tr>
	                                        	</c:forEach>
	                                        </tbody>
	                                    </table>
	                                    ...
	                                    <ul class="pagination">
						  					<li>
												<a href="<c:url value="/subject/leader/index${subjectList.firstPage}.html"/>">&lt;&lt;</a>
											</li>
										  	<c:if test="${subjectList.hasPreviousPage eq true}">
										  		<li>
											  		<a href="<c:url value="/subject/leader/index${subjectList.prePage}.html"/>">&lt;</a>
												</li>	
										  	</c:if>
											<li>
											...
											<c:if test="${subjectList.hasNextPage eq true}">
										  		<li>
											  		<a href="<c:url value="/subject/leader/index${subjectList.nextPage}.html"/>">&gt;</a>
												</li>	
										  	</c:if>
											<li>
										  		<a href="<c:url value="/subject/leader/index${subjectList.lastPage}.html"/>">&gt;&gt;</a>
											</li>
										</ul>
	                                </div>
	                            </div>
