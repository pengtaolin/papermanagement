									...
									<div class="card-body">
										...
										<ul class="icons-list">
											...
											<li><i class="fa fa-automobile"></i>
												<div>automobile <span class="text-muted">(alias)</span></div>
											</li>
											<li><i class="fa fa-ban"></i>
												<div>ban</div>
											</li>
											<li><i class="fa fa-bank"></i>
												<div>bank <span class="text-muted">(alias)</span></div>
											</li>
											<li><i class="fa fa-bar-chart"></i>
												<div>bar-chart</div>
											</li>
											<li><i class="fa fa-bar-chart-o"></i>
												<div>bar-chart-o <span class="text-muted">(alias)</span></div>
											</li>
											...
											<li><i class="fa fa-bell-slash"></i>
												<div>bell-slash</div>
											</li>
											<li><i class="fa fa-bell-slash-o"></i>
												<div>bell-slash-o</div>
											</li>
											...
											<li><i class="fa fa-cab"></i>
												<div>cab <span class="text-muted">(alias)</span></div>
											</li>
											...
											<li><i class="fa fa-camera-retro"></i>
												<div>camera-retro</div>
											</li>
											<li><i class="fa fa-car"></i>
												<div>car</div>
											</li>
											<li><i class="fa fa-caret-square-o-down"></i>
												<div>caret-square-o-down</div>
											</li>
											<li><i class="fa fa-caret-square-o-left"></i>
												<div>caret-square-o-left</div>
											</li>
											<li><i class="fa fa-caret-square-o-right"></i>
												<div>caret-square-o-right</div>
											</li>
											<li><i class="fa fa-caret-square-o-up"></i>
												<div>caret-square-o-up</div>
											</li>
											<li><i class="fa fa-cart-arrow-down"></i>
												<div>cart-arrow-down</div>
											</li>
											...
											<li><i class="fa fa-close"></i>
												<div>close <span class="text-muted">(alias)</span></div>
											</li>
											...
											<li><i class="fa fa-dashboard"></i>
												<div>dashboard <span class="text-muted">(alias)</span></div>
											</li>
											...
											<li><i class="fa fa-dot-circle-o"></i>
												<div>dot-circle-o</div>
											</li>
											<li><i class="fa fa-download"></i>
												<div>download</div>
											</li>
											<li><i class="fa fa-edit"></i>
												<div>edit <span class="text-muted">(alias)</span></div>
											</li>
											...
											<li><i class="fa fa-flag-checkered"></i>
												<div>flag-checkered</div>
											</li>
											<li><i class="fa fa-flag-o"></i>
												<div>flag-o</div>
											</li>
											<li><i class="fa fa-flash"></i>
												<div>flash <span class="text-muted">(alias)</span></div>
											</li>
											...
											<li><i class="fa fa-gear"></i>
												<div>gear <span class="text-muted">(alias)</span></div>
											</li>
											<li><i class="fa fa-gears"></i>
												<div>gears <span class="text-muted">(alias)</span></div>
											</li>
											<li><i class="fa fa-genderless"></i>
												<div>genderless <span class="text-muted">(alias)</span></div>
											</li>
											...
											<li><i class="fa fa-group"></i>
												<div>group <span class="text-muted">(alias)</span></div>
											</li>
											...
											<li><i class="fa fa-hotel"></i>
												<div>hotel <span class="text-muted">(alias)</span></div>
											</li>
											<li><i class="fa fa-image"></i>
												<div>image <span class="text-muted">(alias)</span></div>
											</li>
											...
											<li><i class="fa fa-institution"></i>
												<div>institution <span class="text-muted">(alias)</span></div>
											</li>
											...
											<li><i class="fa fa-legal"></i>
												<div>legal <span class="text-muted">(alias)</span></div>
											</li>
											...
											<li><i class="fa fa-life-bouy"></i>
												<div>life-bouy <span class="text-muted">(alias)</span></div>
											</li>
											<li><i class="fa fa-life-buoy"></i>
												<div>life-buoy <span class="text-muted">(alias)</span></div>
											</li>
											<li><i class="fa fa-life-ring"></i>
												<div>life-ring</div>
											</li>
											<li><i class="fa fa-life-saver"></i>
												<div>life-saver <span class="text-muted">(alias)</span></div>
											</li>
											...
											<li><i class="fa fa-mail-forward"></i>
												<div>mail-forward <span class="text-muted">(alias)</span></div>
											</li>
											<li><i class="fa fa-mail-reply"></i>
												<div>mail-reply <span class="text-muted">(alias)</span></div>
											</li>
											<li><i class="fa fa-mail-reply-all"></i>
												<div>mail-reply-all <span class="text-muted">(alias)</span></div>
											</li>
											...
											<li><i class="fa fa-minus-square-o"></i>
												<div>minus-square-o</div>
											</li>
											<li><i class="fa fa-mobile"></i>
												<div>mobile</div>
											</li>
											<li><i class="fa fa-mobile-phone"></i>
												<div>mobile-phone <span class="text-muted">(alias)</span></div>
											</li>
											...
											<li><i class="fa fa-mortar-board"></i>
												<div>mortar-board <span class="text-muted">(alias)</span></div>
											</li>
											...
											<li><i class="fa fa-navicon"></i>
												<div>navicon <span class="text-muted">(alias)</span></div>
											</li>
											...
											<li><i class="fa fa-pencil-square"></i>
												<div>pencil-square</div>
											</li>
											<li><i class="fa fa-pencil-square-o"></i>
												<div>pencil-square-o</div>
											</li>
											<li><i class="fa fa-phone"></i>
												<div>phone</div>
											</li>
											<li><i class="fa fa-phone-square"></i>
												<div>phone-square</div>
											</li>
											<li><i class="fa fa-photo"></i>
												<div>photo <span class="text-muted">(alias)</span></div>
											</li>
											...
											<li><i class="fa fa-remove"></i>
												<div>remove <span class="text-muted">(alias)</span></div>
											</li>
											<li><i class="fa fa-reorder"></i>
												<div>reorder <span class="text-muted">(alias)</span></div>
											</li>
											...
											<li><i class="fa fa-search-minus"></i>
												<div>search-minus</div>
											</li>
											<li><i class="fa fa-search-plus"></i>
												<div>search-plus</div>
											</li>
											<li><i class="fa fa-send"></i>
												<div>send <span class="text-muted">(alias)</span></div>
											</li>
											<li><i class="fa fa-send-o"></i>
												<div>send-o <span class="text-muted">(alias)</span></div>
											</li>
											...
											<li><i class="fa fa-share-alt-square"></i>
												<div>share-alt-square</div>
											</li>
											<li><i class="fa fa-share-square"></i>
												<div>share-square</div>
											</li>
											<li><i class="fa fa-share-square-o"></i>
												<div>share-square-o</div>
											</li>
											...
											<li><i class="fa fa-sort-down"></i>
												<div>sort-down <span class="text-muted">(alias)</span></div>
											</li>
											<li><i class="fa fa-sort-numeric-asc"></i>
												<div>sort-numeric-asc</div>
											</li>
											<li><i class="fa fa-sort-numeric-desc"></i>
												<div>sort-numeric-desc</div>
											</li>
											<li><i class="fa fa-sort-up"></i>
												<div>sort-up <span class="text-muted">(alias)</span></div>
											</li>
											<li><i class="fa fa-space-shuttle"></i>
												<div>space-shuttle</div>
											</li>
											...
											<li><i class="fa fa-star-half-empty"></i>
												<div>star-half-empty <span class="text-muted">(alias)</span></div>
											</li>
											<li><i class="fa fa-star-half-full"></i>
												<div>star-half-full <span class="text-muted">(alias)</span></div>
											</li>
											...
											<li><i class="fa fa-support"></i>
												<div>support <span class="text-muted">(alias)</span></div>
											</li>
											...
											<li><i class="fa fa-times-circle-o"></i>
												<div>times-circle-o</div>
											</li>
											<li><i class="fa fa-tint"></i>
												<div>tint</div>
											</li>
											<li><i class="fa fa-toggle-down"></i>
												<div>toggle-down <span class="text-muted">(alias)</span></div>
											</li>
											<li><i class="fa fa-toggle-left"></i>
												<div>toggle-left <span class="text-muted">(alias)</span></div>
											</li>
											...
											<li><i class="fa fa-toggle-right"></i>
												<div>toggle-right <span class="text-muted">(alias)</span></div>
											</li>
											<li><i class="fa fa-toggle-up"></i>
												<div>toggle-up <span class="text-muted">(alias)</span></div>
											</li>
											...
											<li><i class="fa fa-unsorted"></i>
												<div>unsorted <span class="text-muted">(alias)</span></div>
											</li>
											...
											<li><i class="fa fa-warning"></i>
												<div>warning <span class="text-muted">(alias)</span></div>
											</li>
										...
										<ul class="icons-list">
											...
											<li><i class="fa fa-mars-stroke-h"></i>
												<div>mars-stroke-h</div>
											</li>
											<li><i class="fa fa-mars-stroke-v"></i>
												<div>mars-stroke-v</div>
											</li>
										...
										<ul class="icons-list">
											...
											<li><i class="fa fa-bitcoin"></i>
												<div>bitcoin <span class="text-muted">(alias)</span></div>
											</li>
											<li><i class="fa fa-btc"></i>
												<div>btc</div>
											</li>
											<li><i class="fa fa-cny"></i>
												<div>cny <span class="text-muted">(alias)</span></div>
											</li>
											<li><i class="fa fa-dollar"></i>
												<div>dollar <span class="text-muted">(alias)</span></div>
											</li>
											<li><i class="fa fa-eur"></i>
												<div>eur</div>
											</li>
											<li><i class="fa fa-euro"></i>
												<div>euro <span class="text-muted">(alias)</span></div>
											</li>
											...
											<li><i class="fa fa-rmb"></i>
												<div>rmb <span class="text-muted">(alias)</span></div>
											</li>
											<li><i class="fa fa-rouble"></i>
												<div>rouble <span class="text-muted">(alias)</span></div>
											</li>
											<li><i class="fa fa-rub"></i>
												<div>rub</div>
											</li>
											<li><i class="fa fa-ruble"></i>
												<div>ruble <span class="text-muted">(alias)</span></div>
											</li>
											<li><i class="fa fa-rupee"></i>
												<div>rupee <span class="text-muted">(alias)</span></div>
											</li>
											<li><i class="fa fa-shekel"></i>
												<div>shekel <span class="text-muted">(alias)</span></div>
											</li>
											<li><i class="fa fa-sheqel"></i>
												<div>sheqel <span class="text-muted">(alias)</span></div>
											</li>
											<li><i class="fa fa-try"></i>
												<div>try</div>
											</li>
											<li><i class="fa fa-turkish-lira"></i>
												<div>turkish-lira <span class="text-muted">(alias)</span></div>
											</li>
											<li><i class="fa fa-usd"></i>
												<div>usd</div>
											</li>
											<li><i class="fa fa-won"></i>
												<div>won <span class="text-muted">(alias)</span></div>
											</li>
											<li><i class="fa fa-yen"></i>
												<div>yen <span class="text-muted">(alias)</span></div>
											</li>
										</ul>
										...
										<ul class="icons-list">
											...
											<li><i class="fa fa-chain"></i>
												<div>chain <span class="text-muted">(alias)</span></div>
											</li>
											<li><i class="fa fa-chain-broken"></i>
												<div>chain-broken</div>
											</li>
											...
											<li><i class="fa fa-copy"></i>
												<div>copy <span class="text-muted">(alias)</span></div>
											</li>
											<li><i class="fa fa-cut"></i>
												<div>cut <span class="text-muted">(alias)</span></div>
											</li>
											<li><i class="fa fa-dedent"></i>
												<div>dedent <span class="text-muted">(alias)</span></div>
											</li>
											<li><i class="fa fa-eraser"></i>
												<div>eraser</div>
											</li>
											...
											<li><i class="fa fa-paste"></i>
												<div>paste <span class="text-muted">(alias)</span></div>
											</li>
											<li><i class="fa fa-repeat"></i>
												<div>repeat</div>
											</li>
											<li><i class="fa fa-rotate-left"></i>
												<div>rotate-left <span class="text-muted">(alias)</span></div>
											</li>
											<li><i class="fa fa-rotate-right"></i>
												<div>rotate-right <span class="text-muted">(alias)</span></div>
											</li>
											<li><i class="fa fa-save"></i>
												<div>save <span class="text-muted">(alias)</span></div>
											</li>
											...
											<li><i class="fa fa-unlink"></i>
												<div>unlink <span class="text-muted">(alias)</span></div>
											</li>
										</ul>
										...
										<ul class="icons-list">
											...
											<li><i class="fa fa-angle-double-down"></i>
												<div>angle-double-down</div>
											</li>
											<li><i class="fa fa-angle-double-left"></i>
												<div>angle-double-left</div>
											</li>
											<li><i class="fa fa-angle-double-right"></i>
												<div>angle-double-right</div>
											</li>
										...
										<ul class="icons-list">
											...
											<li><i class="fa fa-ge"></i>
												<div>ge <span class="text-muted">(alias)</span></div>
											</li>
											...
											<li><i class="fa fa-github-square"></i>
												<div>github-square</div>
											</li>
											<li><i class="fa fa-gittip"></i>
												<div>gittip <span class="text-muted">(alias)</span></div>
											</li>
											...
											<li><i class="fa fa-meanpath"></i>
												<div>meanpath</div>
											</li>
											<li><i class="fa fa-medium"></i>
												<div>medium</div>
											</li>
											...
											<li><i class="fa fa-pied-piper-alt"></i>
												<div>pied-piper-alt</div>
											</li>
											<li><i class="fa fa-pinterest"></i>
												<div>pinterest</div>
											</li>
											<li><i class="fa fa-pinterest-p"></i>
												<div>pinterest-p</div>
											</li>
											<li><i class="fa fa-pinterest-square"></i>
												<div>pinterest-square</div>
											</li>
											<li><i class="fa fa-qq"></i>
												<div>qq</div>
											</li>
											<li><i class="fa fa-ra"></i>
												<div>ra <span class="text-muted">(alias)</span></div>
											</li>
											...
											<li><i class="fa fa-reddit-square"></i>
												<div>reddit-square</div>
											</li>
											<li><i class="fa fa-renren"></i>
												<div>renren</div>
											</li>
											<li><i class="fa fa-sellsy"></i>
												<div>sellsy</div>
											</li>
											<li><i class="fa fa-share-alt"></i>
												<div>share-alt</div>
											...
											<li><i class="fa fa-shirtsinbulk"></i>
												<div>shirtsinbulk</div>
											</li>
											<li><i class="fa fa-simplybuilt"></i>
												<div>simplybuilt</div>
											</li>
											<li><i class="fa fa-skyatlas"></i>
												<div>skyatlas</div>
											</li>
											...
											<li><i class="fa fa-tumblr-square"></i>
												<div>tumblr-square</div>
											</li>
											<li><i class="fa fa-twitch"></i>
												<div>twitch</div>
											</li>
											...
											<li><i class="fa fa-twitter-square"></i>
												<div>twitter-square</div>
											</li>
											<li><i class="fa fa-viacoin"></i>
												<div>viacoin</div>
											</li>
											<li><i class="fa fa-vimeo-square"></i>
												<div>vimeo-square</div>
											</li>
											...
											<li><i class="fa fa-wechat"></i>
												<div>wechat <span class="text-muted">(alias)</span></div>
											</li>
